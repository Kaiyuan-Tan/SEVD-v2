...
def main():
    ...
    try:
        ...
        # spawn camera
        # camera_bp_1 = bp_lib.find('sensor.camera.rgb')
        # camera_bp_2 = bp_lib.find('sensor.camera.rgb')
        # camera_bp_3 = bp_lib.find('sensor.camera.rgb')
        # camera_bp_4 = bp_lib.find('sensor.camera.rgb')
        # camera_bp_5 = bp_lib.find('sensor.camera.rgb')
        # camera_bp_6 = bp_lib.find('sensor.camera.rgb')
        # camera_bp_7 = bp_lib.find('sensor.camera.rgb')
        rgb_camera_bp_list = []
        semantic_camera_bp_list = []
        ...
        for j, camera_list in enumerate(total_camera_list):
            ...
            for i, camera in enumerate(camera_list):
                ...
                if j == 1:
                    ...
                    # camera.listen(lambda data: image_queue_list[i].put(dvs_api.dvs_callback(data, dvs_output_path)))
                    camera.listen(lambda data, index=i, path=dvs_output_path: 
                                image_queue_list[index].put(dvs_api.dvs_callback(data, path)))
