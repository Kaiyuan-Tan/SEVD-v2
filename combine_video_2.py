...
video_paths = [f"videos/{i}.avi" for i in range(35)]  # Assuming videos are named 0.avi to 34.avi
...
output_width, output_height = scaled_w * 7, scaled_h * 5  # 7 videos per row, 5 rows
